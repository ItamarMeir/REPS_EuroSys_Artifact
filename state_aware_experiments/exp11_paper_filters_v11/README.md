...
bash state_aware_experiments/exp11_paper_filters_v11/scripts/v11_run_matrix.sh --jobs 4

# Aggregate + plot
python3 state_aware_experiments/exp11_paper_filters_v11/scripts/v11_aggregate.py
python3 state_aware_experiments/exp11_paper_filters_v11/scripts/v11_plot.py
```
