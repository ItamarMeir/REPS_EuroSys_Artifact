...
9 algorithms × 2 CC modes × 3 seeds = 54 runs

**Algorithms**: path_static, freezing_b1, freezing_b2, freezing_b4, freezing_b8,
freezing_b16, freezing_b32, freezing_b64, reps (all with `-use_srv6`)
...
```bash
bash state_aware_experiments/exp22_link_failure_v22/scripts/run_exp22.sh
python3 state_aware_experiments/exp22_link_failure_v22/scripts/aggregate.py
python3 state_aware_experiments/exp22_link_failure_v22/scripts/plot.py
python3 state_aware_experiments/exp22_link_failure_v22/scripts/plot_ecn.py
python3 state_aware_experiments/exp22_link_failure_v22/scripts/plot_ev_diversity.py
python3 state_aware_experiments/exp22_link_failure_v22/scripts/plot_ev_heatmap.py
```
