...
python3 state_aware_experiments/workloads/gen_paper_workloads.py

# Part A — buffer sweep (120 cells, ~10–15 min at J=4 on this hardware)
bash state_aware_experiments/exp10_paper_buf_ev_v10/scripts/v10_run_matrix.sh --part_a --jobs 4

# Part B — EV sweep (72 cells, ~10 min at J=4)
bash state_aware_experiments/exp10_paper_buf_ev_v10/scripts/v10_run_matrix.sh --part_b --jobs 4

# Aggregate + plot
python3 state_aware_experiments/exp10_paper_buf_ev_v10/scripts/v10_aggregate.py
python3 state_aware_experiments/exp10_paper_buf_ev_v10/scripts/v10_plot.py
```
