...
bash state_aware_experiments/exp23_freezing_pxr_v23/scripts/run_exp23.sh

# 3. Aggregate (reads exp22 B=8 baseline from exp22/runs.tar.gz)
python3 state_aware_experiments/exp23_freezing_pxr_v23/scripts/aggregate.py

# 4. Plot
python3 state_aware_experiments/exp23_freezing_pxr_v23/scripts/plot_fct.py
python3 state_aware_experiments/exp23_freezing_pxr_v23/scripts/plot_excluded.py

# 5. Compress runs
tar -czf state_aware_experiments/exp23_freezing_pxr_v23/runs.tar.gz \
    -C state_aware_experiments/exp23_freezing_pxr_v23/runs . && \
rm -rf state_aware_experiments/exp23_freezing_pxr_v23/runs/
```
