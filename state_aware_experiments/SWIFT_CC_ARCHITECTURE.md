...
- **exp12** (`state_aware_experiments/exp12_paper_repro_reps/`) — initial Paper 2 Fig 4
  reproduction attempt. Identified the `target-qdelay-respect-cli` bug.
- **exp13** (`state_aware_experiments/exp13_papers_reps_repro/`) — full multi-phase paper
