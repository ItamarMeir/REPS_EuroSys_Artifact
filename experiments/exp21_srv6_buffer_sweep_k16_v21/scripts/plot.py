...
DATA_CSV   = EXP_DIR / "data" / "exp21_flows.csv"
...
def plot_8mb(df: pd.DataFrame):
    ...
    for metric, title, ylabel, fname in [
        ("mean_fct",
         f"Mean FCT / PATH_STATIC-constant — K=16 tornado 8 MB, SRv6 buffer sweep",
         "Mean FCT  /  PATH_STATIC-constant FCT",
         "mean_fct.png"),
        ("p99_fct",
         f"p99 FCT / PATH_STATIC-constant — K=16 tornado 8 MB, SRv6 buffer sweep",
         "p99 FCT  /  PATH_STATIC-constant FCT",
         "p99_fct.png"),
        ("slowdown",
         f"Mean slowdown / PATH_STATIC-constant — K=16 tornado 8 MB, SRv6 buffer sweep",
