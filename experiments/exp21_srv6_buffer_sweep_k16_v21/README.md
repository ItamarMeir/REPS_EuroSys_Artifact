...
| `oblivious64` | OBLIVIOUS (stateless random EV, pool=64) | — | yes |
...
already set by the shared `-paths 64` flag) — per-packet uniform-random EV draw out of
the same 64-EV pool, no REPS-style reuse/tracking (OPS-style baseline). +6 runs
(2 CC modes × 3 seeds).
