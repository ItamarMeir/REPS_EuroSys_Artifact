...
# 16 MiB + 64 MiB runs:
bash experiments/exp17_cwnd_corrected_v17/scripts/01_run_exp17.sh

# 256 MiB runs:
bash experiments/exp17_cwnd_corrected_v17/scripts/02_run_exp17_256mib.sh

# Aggregate and plot:
python3 experiments/exp17_cwnd_corrected_v17/aggregate_exp17.py
python3 experiments/exp17_cwnd_corrected_v17/plot_exp17.py
python3 experiments/exp17_cwnd_corrected_v17/plot_exp17_256mib.py
```
