...
| `composite` | `experiments/workloads/composite.cm` |
...
bash experiments/exp07_filter_compare_v7/scripts/v7_run_matrix.sh

# Optional dry-run to preview commands
bash experiments/exp07_filter_compare_v7/scripts/v7_run_matrix.sh --dry-run

# Aggregate to CSVs
python3 experiments/exp07_filter_compare_v7/scripts/v7_aggregate.py

# Generate plots (7 PNGs to plots/)
python3 experiments/exp07_filter_compare_v7/scripts/v7_plot.py

# Compress raw runs (after analysis)
tar -czf experiments/exp07_filter_compare_v7/runs.tar.gz \
    -C experiments/exp07_filter_compare_v7/runs . \
  && rm -rf experiments/exp07_filter_compare_v7/runs/
```
