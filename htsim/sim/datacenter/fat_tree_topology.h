...
typedef enum {UNDEFINED, RANDOM, ECN, COMPOSITE, PRIORITY,
              ...
              COMPOSITE_ECN, COMPOSITE_ECN_LB, SWIFT_SCHEDULER, ECN_PRIO,
              AEOLUS, AEOLUS_ECN, STATEFUL_ECN} queue_type;
...
public:
    ...
    int disable_links_count = 0;
    int disable_links_tot = 1;
    static bool skip_asy;

    int degraded_cables = 0;
